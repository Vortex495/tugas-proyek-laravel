                            ...
                            <div class="row z-index-2 justify-content-center align-items-center">
                                <div class="col-sm-auto col-4">
                                    <div class="avatar avatar-xl position-relative">
                                        <img src="../assets/img/vadel.jpg" alt="bruce"
                            ...
                            <div class="pt-0 card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="nomor_hp" id="nomor_hp" placeholder="Masukan Nomor HP anda"
                                            value="{{ old('nomor_hp', auth()->user()->nomor_hp) }}" class="form-control">
                                        @error('nomor_hp')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row p-2">
                                    ...
                                    <textarea name="deskripsi" id="deskripsi" rows="5" class="form-control">{{ old('deskripsi', auth()->user()->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
