<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">Menu</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Database</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('customer') ? 'active' : '' }}"
                    href="{{ route('customer') }}">
                    <span class="nav-link-text ms-1">Customer</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('mechanic') ? 'active' : '' }}"
                    href="{{ route('mechanic') }}">
                    <span class="nav-link-text ms-1">Mechanic</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('car') ? 'active' : '' }}"
                    href="{{ route('car') }}">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('users.profile') ? 'active' : '' }}" href="{{ route('users.profile') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="60px" height="60px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>About</title>
